...
# # I was getting crash when hog_channel == 'ALL'
# def get_hog_features_all(feature_image, orient, pix_per_cell, cell_per_block, 
#                         vis=False, feature_vec=True):
#     hog_features = []
#     hog_feat1 = get_hog_features(feature_image[:,:,0], orientations=orient, 
#                                   pixels_per_cell=(pix_per_cell, pix_per_cell),
#                                   cells_per_block=(cell_per_block, cell_per_block),
#                                   block_norm='L2-Hys', 
#                                   transform_sqrt=True, 
#                                   visualise=vis, feature_vector=feature_vec) 
#     hog_feat2 = get_hog_features(feature_image[:,:,1], orientations=orient, 
#                                   pixels_per_cell=(pix_per_cell, pix_per_cell),
#                                   cells_per_block=(cell_per_block, cell_per_block),
#                                   block_norm='L2-Hys', 
#                                   transform_sqrt=True, 
#                                   visualise=vis, feature_vector=feature_vec) 
#     hog_feat3 = get_hog_features(feature_image[:,:,2], orientations=orient, 
#                                   pixels_per_cell=(pix_per_cell, pix_per_cell),
#                                   cells_per_block=(cell_per_block, cell_per_block),
#                                   block_norm='L2-Hys', 
#                                   transform_sqrt=True, 
